...
window.FX = (function () {
  ...
  const groups = [
    ...
    },
    {
      id: 'read', label: 'Read / scrape', providers: [
        { name: 'jina', desc: 'Reader — URL → markdown', used: 533, quota: 1000000, resetWindow: 'monthly', resetsIn: '12d', accounts: 1, key: true },
    ...
    },
    {
      id: 'web', label: 'Web sessions', providers: [
        { name: 'perplexity_web', desc: 'Browser session · search + deep research', used: 300, quota: 300, resetWindow: 'monthly', resetsIn: '3d', accounts: 1, webSession: true, loggedIn: true, dr: { used: 0, quota: 5 } },
  ...
  const accounts = [
    ...
    { provider: 'jina', label: 'jina-1', used: 533, quota: 1000000, resetWindow: 'monthly', proxy: 'direct', status: 'healthy', key: true, web: false },
    ...
    { provider: 'perplexity_web', label: 'perplexity-1', used: 300, quota: 300, resetWindow: 'monthly', proxy: 'direct', status: 'exhausted', key: false, web: true, loggedIn: true },
  ...
  const log = [
    ...
    { time: '14:21:50', capability: 'read', provider: 'jina', account: 1, status: 200, latencyMs: 612 },
    ...
    { time: '14:22:09', capability: 'search', failover: { from: 'perplexity-1', code: 503, to: 'serper-1' }, status: 200, latencyMs: 221 },
  ...
  const stream = [
    ...
    { capability: 'read', provider: 'jina', account: 1, status: 200, latencyMs: 588 },
  ...
  const health = [
    ...
    { provider: 'jina-1', state: 'healthy', lastSuccess: '8s ago', lastError: null },
    { provider: 'parallel-1', state: 'healthy', lastSuccess: '1s ago', lastError: null },
    { provider: 'perplexity-1', state: 'exhausted', lastSuccess: '2h ago', lastError: '503 quota_exhausted — 300/300 monthly, resets in 3d' },
